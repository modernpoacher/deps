"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.getDepsExact=getDepsExact;exports.getDeps=getDeps;exports.transform=transform;exports.transformDependency=exports.isExact=exports.getPeerDependencies=exports.getBundleDependencies=exports.getOptionalDependencies=exports.getDevDependencies=exports.getProdDependencies=exports.NVM=void 0;var _debug=_interopRequireDefault(require("debug"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}const log=(0,_debug.default)('@modernpoacher/deps');log('`common` is awake');const NVM=`
NVM=~/.nvm
if [ -f "$NVM/nvm.sh" ];
then
  source $NVM/nvm.sh
