...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveBundle(d,p,c,r){log('installSaveBundle');return new Promise((resolve,reject)=>{const commands=getSaveBundleCommands(p,c,r);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveOptionalExact(d,p,c,r){log('installSaveOptionalExact');return new Promise((resolve,reject)=>{const commands=getSaveOptionalCommands(p,c,r,true);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveOptional(d,p,c,r){log('installSaveOptional');return new Promise((resolve,reject)=>{const commands=getSaveOptionalCommands(p,c,r);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveDevExact(d,p,c,r){log('installSaveDevExact');return new Promise((resolve,reject)=>{const commands=getSaveDevCommands(p,c,r,true);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveDev(d,p,c,r){log('installSaveDev');return new Promise((resolve,reject)=>{const commands=getSaveDevCommands(p,c,r);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveProdExact(d,p,c,r){log('installSaveProdExact');return new Promise((resolve,reject)=>{const commands=getSaveProdCommands(p,c,r,true);(0,_child_process.spawn)(`
#!/bin/sh
...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function installSaveProd(d,p,c,r){log('installSaveProd');return new Promise((resolve,reject)=>{const commands=getSaveProdCommands(p,c,r);(0,_child_process.spawn)(`
#!/bin/sh
