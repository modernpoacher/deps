...
`,['npm'].concat(commands),{shell:true,stdio:'inherit'},e=>!e?resolve():reject(e)).on('close',resolve).on('error',reject);});}function install(d,p,c,s,r){return new Promise((resolve,reject)=>{const commands=getCommands(p,c,s,r);(0,_child_process.spawn)(`
#!/bin/sh
